  ...
  (h.WidgetAbstract.prototype = {
    ...
    width: function () {
      return this.options.autosize
        ? "100%"
        : h.WidgetAbstract.prototype.fixSize(this.options.width);
    },
    height: function () {
      return this.options.autosize
        ? "100%"
        : h.WidgetAbstract.prototype.fixSize(this.options.height);
    },
    ...
    addFooterLogo: function (e, t) {
      ...
      return h.WidgetAbstract.prototype.addWrapperFrame.call(
        this,
        e,
        '<div style="position:absolute;display: block;box-sizing: content-box;height: 24px;width: ' +
          h.WidgetAbstract.prototype.width.call(this) +
    ...
    (h.MiniWidget.prototype = {
      ...
      widgetCode: function () {
        ...
        for (
          var l = "&" + h.generateUtmForUrlParams(this.options),
            c = [
              "large_chart_url",
              "large_chart_target",
              "backgroundColor",
    ...
    (h.MediumWidget.prototype = {
      ...
      widgetCode: function () {
        ...
        return (
          this.options.customer && (o.pathname += this.options.customer + "/"),
          this.options.locale &&
            o.searchParams.append("locale", this.options.locale),
          (o.hash = encodeURIComponent(JSON.stringify(e))),
          '<iframe id="' +
            this.id +
            '" src="' +
            o.href +
    ...
    (h.widget.prototype = {
      create: function () {
        ...
        o && o.parentElement && o.parentElement.removeChild(o),
          ...
          t.postMessage.on("openChartInPopup", function (e) {
            for (
              var o = h.cloneSimpleObject(t.options),
                i = ["symbol", "interval"],
                r = i.length - 1;
              r >= 0;
              r--
      ...
      generateUrl: function (e) {
        ...
        var s =
          (e.enable_publishing ? h.ideasHost : h.getHost(e)) +
          t +
          "?frameElementId=" +
          this.id +
          "&symbol=" +
          ...
          (e.type && "chart" === e.type
            ...
            : "");
        return (
          (n["page-uri"] = h.getPageUriString()),
          (s = s + "#" + encodeURIComponent(JSON.stringify(n)))
        );
      },
      image: function (e) {
    ...
    (h.chart.prototype = {
      create: function () {
        ...
        var e,
          ...
          o = this;
        h.chartCssAttached ||
          (h.css(this.renderCss()), (h.chartCssAttached = !0)),
          c(t, this.options.container),
          (e = document.getElementById(this.id)),
          h.bindEvent(e, "load", function () {
            var e;
          ...
          (this.postMessage = h.postMessageWrapper(e.contentWindow, this.id)),
          this.postMessage.on(
            "toggleFullscreen",
            function (t) {
        ...
        window.addEventListener("message", function (e) {
          ...
          if (t && t.provider && "TradingView" === t.provider)
            if (((t.source = e.source), "get" === t.type)) {
              ...
              r[t.client_id] &&
                r[t.client_id][t.id] &&
                (r[t.client_id][t.id].call(t, t.data),
